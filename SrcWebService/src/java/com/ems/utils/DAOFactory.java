...
//    private static final String PROPERTY_PASSWORD = "password";
	...
	protected static final String DB_PASSWORD = "DB_PASS";
	protected static final String DB_NAME = "DB_NAME";
	protected static final String TYPE_MYSQL = "TYPE_MYSQL";
	protected static final String DB_DRIVER = "DB_DRIVER";
        protected static final String DB_DRIVER_CONNECT_STRING = "DB_DRIVER_CONNECT_STRING";
	protected static final String DEFAULT_PORT = "DEFAULT_PORT";
        protected static DAOProperties properties;
        
	
	//private final String JDBC_PREFIX = "jdbc:";
	
    
    protected static final Map<String, DAOFactory> INSTANCES = new HashMap<String, DAOFactory>();
...
//    private String password;
	...
	private String dbPort = null;
        private String driverConnectionString = null;
